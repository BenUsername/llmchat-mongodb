...
> = {
    // OpenAI Models Only (simplified for initial deployment)
    ...
    // Default configs for commented out models (to prevent TypeScript errors)
    [ChatMode.Deep]: {
        webSearch: false,
        imageUpload: false,
        retry: false,
...
export const CHAT_MODE_CREDIT_COSTS = {
    ...
    // Default costs for commented out models (to prevent TypeScript errors)
    [ChatMode.Pro]: 5,
    [ChatMode.Deep]: 10,
    [ChatMode.GPT_4_1]: 5,
